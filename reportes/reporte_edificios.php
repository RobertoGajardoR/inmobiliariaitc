...
function NbLines($w,$txt)
{
   ...
   function Header()
   {
    ...
    $this->Cell(160);
    //Título
    $this->Cell(89,35,'Lista de edificios',1,1,'C');
    //Salto de línea
...
function Footer()
{
    ...
    $pdf->SetTextColor(255);
		...
		for($i=0;$i<1;$i++)
			{
				$pdf->Row(array('ID_edificio', 'Nombre', 'Ubicacion','Direccion'));
			}
	...
	for ($i=0; $i<$numfilas; $i++)
		{
			...
			$ubicacion = utf8_decode($fila['ubicacion']);
			...
			if($i%2 == 1)
			{
    			...
    			$pdf->SetTextColor(0);
    			$pdf->Row(array($id,$nombre, $ubicacion,$direccion));
...
$pdf->Output("ListaEdificios.pdf","I");
?>
