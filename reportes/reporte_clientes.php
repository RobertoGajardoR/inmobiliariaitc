...
function NbLines($w,$txt)
{
   ...
   function Header()
   {
    ...
    $this->Cell(160);
    //Título
    $this->Cell(89,35,'Lista de Clientes',1,1,'C');
    //Salto de línea
...
function Footer()
{
	...
	$pdf->SetWidths(array(30,30, 65, 45,30,39));
    ...
    $pdf->SetTextColor(255);
		...
		for($i=0;$i<1;$i++)
			{
				$pdf->Row(array('ID cliente', 'Numero recibo','Nombre completo', 'RUT','Sexo','Codigo inmueble'));
			}
	...
	for ($i=0; $i<$numfilas; $i++)
		{
			...
			if($i%2 == 1)
			{
    			...
    			$pdf->SetTextColor(0);
    			$pdf->Row(array($id,$numrecibo, $nombre.' '.$apellidos,$rut,$sexo,$Codigoinmueble));
...
$pdf->Output("ListaClientes.pdf","I");
?>